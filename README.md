...
3. **Terminal 3 – Frontend**  
   `cd frontend && npm install && npm run dev`
4. Ouvrir **http://localhost:5173** : le dashboard affiche les postures et alertes en temps réel (données générées par la gateway).
...
7. **Lancer le frontend** (terminal 3) : `cd frontend && npm run dev` → ouvrir http://localhost:5173.
